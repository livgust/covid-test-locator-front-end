import React, {createContext} from 'react'; //useEffect, useRef, useState} from 'react';
import {
  //Alert,
  AppBar,
  Box,
      ...
      <>
        <Paper sx={{p: 2}}>
          <Typography variant="h5" component="h1">
            This tool is disabled until it is needed again.
          </Typography>
          <Typography>
            <b>Thank you</b> for your involvement.
            <br />
            If rapid tests ever become scarce again, we'll restart this tool.
          </Typography>
        </Paper>
      </>
      <Box sx={{mt: 2}}>
